...
product* priced_products(product* product_list, int size, float price)
{
    int new_size = 0;
...
// Test #1:
    ...
    product* my_priced_products = priced_products(product_list, 3, 2.00);
    print_products(my_priced_products, 2);
